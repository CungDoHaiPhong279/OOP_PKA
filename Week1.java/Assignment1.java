...
public class Assignment1 {
    ...
    n1.i = n2.i; // gan gia tri 5 cho bien i cua doi tuong n2
    n2.i = 10; // thay doi gia tri cua n2.i = 10
    System.out.println(n1.i); //khi gan n1.i = n2.i thi gtri cua n1.i = 5. thay doi n2.i k lam anh huong den gtri cua n1.i
    }
   }